...
label tpi_kart1: #DONE
    scene black
    show text "{color=#FFF}{size=+30} Kartkówka z TPI {/size}{/color}"
    pause 5
    hide text
    scene bg white
    show countdown at Position(xalign=.9, yalign=.1)
    $ ui.timer(45.1, ui.jumps("next_tpi_kart1_q1_wrong"))
...
label next_tpi_kart1_q2:
    show countdown at Position(xalign=.9, yalign=.1)
    $ ui.timer(45.1, ui.jumps("next_tpi_kart1_q2_wrong"))
...
label next_tpi_kart1_q3:
    show countdown at Position(xalign=.9, yalign=.1)
    $ ui.timer(45.1, ui.jumps("next_tpi_kart1_q3_wrong"))
