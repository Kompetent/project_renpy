...
label chapter5:
    ...
    $ zaliczone = 0
    ob "Ho ho ho. Widzę, że Twoja przygoda z Wonderful time dobiega już końca. Cieszę się, że mogłem śledzić Twe poczynania"
    ob "Mówiłem Ci kiedyś, że jeszcze się zobaczymy. Oto jestem, bym mógł podsumować całą Twoją rozgrywkę."
    ...
    if ocena_egz_pe >= 3:
        python:
            zaliczone += 1
        ob "Popatrzmy na Podstawy Elektroniki. Całkiem, całkiem Ci to wyszło! Dziekan to naprawdę miła..."
        ...
        ob "Co raz więcej programistów zapomina o tym, że wiedza na temat sprzetu jest istotna. Mam nadzieję, że następnym razem będziesz uważniej słuchać Dziekana!"
    #----------------------------------------------------------------------------------------------
    ...
    if ocena_egz_tpi >= 3:
        ...
        ob "jak ten ostatni uszło mu płazem. Nie patrz na wykładowców przez pryzmat Ikara. Źli ludzie zdarzają się wszędzie."
        ...
        ob "Wiem, że każdy chciałby uczyć się poprzez praktykę, ale bez teori daleko sie nie zajedzie."
        ob "Przyłóż się pilniej do tego przedmiotu. Gwarantuję, że wyjdziesz z tym na dobre!"
    #---------------------------------------------------------------------------------------------------------
    #Prawo inżynierskie
    if ocena_egz_prawo >= 3:
        ...
        ob "Prawo inżynierskie...niestety dość kiepsko Ci poszło. Zdaję sobię sprawę, że przedmiot nie był jakiś porywający, ale to nie znaczy, że można go olać!"
    ...
    if ocena_egz_mat >= 3:
        ...
        ob "Matematyka rozwija logiczne myślenie i pomaga w programowaniu. Sądzę, że warto do niej przysiąść."
#--------------------------------------------------------------------------------------------------------
    if zaliczone == 0:
    ...
    if marta_zostala_uspokojona:
        ...
        ob "Szkoda, że jednak nie pomogłaś Marcie. Wiem, że tego żałujesz, ale musisz zawsze pamiętać o konsekwencjach swoich decyzji. Na tym polega dorosłe życie."
    #----------------------------------------------------------------------------------------------------------
    ...
    if piwo_piatek2 or piwo_piatek3:
        ...
        ob "Mimo wielu poznanycch ludzi nie zbliżyłeś/zbliżyłaś się do nich. To bardzo smutne. Osiągnięcie postawionych sobie celów"
        ob "jest bardzo ważne, ale kontakty międzyludzkie też. Z kim będziesz świętować swoje sukcesy? Kto będzie Cię wspierał podczas trudnych chwil?"
    ...
    ob "Myślę, że jeśli dasz jej szansę się otwozyć to będzie można pomóc jej się zmienić. Głęboko w to wierzę!"
    ...
    if zaliczone == 5:
        ...
        m "Heh, dzięki. Jak Tobie poszło? Musimy sprawdzić kto wygrał!"
        ...
        m "Sądzę, że jest. Udowodniłaś mi to podczas naszego wypadku."
        malfoy "Dziękuję...zdajesz sobie sprawę z jakim beznadziejnym uczniem będziesz miała do czynienia?"
